                ...
                <div class="col-span-6 sm:col-full">
                    <div class="flex items-center justify-end gap-3">
                        <NuxtLink
                            ...
                            to="/private/app/users/create" type="submit">Créer
                        </NuxtLink>
                    </div>
                </div>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tr v-for="user in users" :key="user.id" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <NuxtLink :to="`/private/app/users/${user.id}/edit`" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800">
